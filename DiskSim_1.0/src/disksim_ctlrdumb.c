...
void controller_53c700_reset_complete(currctlr, curr)
controller *currctlr;
ioreq_event *curr;
{
   ioreq_event *tmp;
...
void controller_53c700_reconnection_complete(currctlr, curr)
controller *currctlr;
ioreq_event *curr;
{
...
void controller_53c700_reconnect_to_transfer(currctlr, curr)
controller *currctlr;
ioreq_event *curr;
{
   switch (currctlr->state) {
...
void controller_53c700_request_complete(currctlr, curr)
controller *currctlr;
ioreq_event *curr;
{
   ioreq_event *ret;
...
void controller_53c700_disconnect(currctlr, curr)
controller *currctlr;
ioreq_event *curr;
{
   ioreq_event *ret;
...
void controller_53c700_ready_to_transfer(currctlr, curr)
controller *currctlr;
ioreq_event *curr;
{
...
void controller_53c700_request_arrive(currctlr, curr)
controller *currctlr;
ioreq_event *curr;
{
/*
...
void controller_53c700_interrupt_arrive(currctlr, curr)
controller *currctlr;
ioreq_event *curr;
{
   switch (curr->cause) {
...
void controller_53c700_interrupt_complete(currctlr, curr)
controller *currctlr;
ioreq_event *curr;
{
   switch (curr->cause) {
...
void controller_53c700_data_transfer(currctlr, curr)
controller *currctlr;
ioreq_event *curr;
{
   ioreq_event *tmp;
...
*/
   if (curr->type == DISK_DATA_TRANSFER_COMPLETE) {
...
void controller_53c700_data_transfer_complete(currctlr, curr)
controller *currctlr;
ioreq_event *curr;
{
   ioreq_event *tmp;
...
void controller_53c700_event_arrive(currctlr, curr)
controller *currctlr;
ioreq_event *curr;
{
   int busno;
...
void controller_passthru_event_arrive(currctlr, curr)
controller *currctlr;
ioreq_event *curr;
{
   int busno;
...
void controller_passthru_printstats(currctlr, prefix)
controller *currctlr;
char *prefix;
{
}
...
void controller_53c700_printstats(currctlr, prefix)
controller *currctlr;
char *prefix;
{
}
